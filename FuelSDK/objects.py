from .rest import (ET_Configure, ET_CUDSupport, ET_CUDSupportRest, ET_Delete,
                   ET_Get, ET_GetSupport, ET_Patch, ET_Post)
...
class ET_TriggeredSend(ET_CUDSupport):
    ...
    def send(self):
        tscall = {
            'TriggeredSendDefinition': self.props,
